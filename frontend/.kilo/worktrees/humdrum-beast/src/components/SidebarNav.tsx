...
const SidebarNav: React.FC = () => {
  ...
  return (
    <>
      {/* ── Header ── */}
      <div data-slot="sidebar-header" data-sidebar="header" className="p-3">
        {/* Brand */}
        <div className="flex items-center gap-3 rounded-xl bg-gradient-to-br from-zarin-navy to-zarin-navy-soft p-2.5 shadow-lg">
          ...
          {!isCollapsed && (
            <div className="min-w-0 flex-1">
              <span className="block text-sm font-black text-white tracking-tight">زرین‌پال</span>
              <span className="block text-[10px] font-medium text-white/70">پلتفرم هوشمند</span>
            </div>
          )}
        </div>
      ...
      <div data-slot="sidebar-footer" data-sidebar="footer" className="p-2">
        ...
        <button
          ...
          className={cn(
            'mt-2 flex w-full items-center justify-center gap-2 rounded-lg p-2 text-xs font-bold text-muted-foreground transition-all duration-200',
            'hover:bg-sidebar-accent hover:text-sidebar-accent-foreground',
            'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/40',
          )}
        >
